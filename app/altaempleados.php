...
<p>Ingrese los datos del empleado en los campos.</p>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if( $_POST["nombre"] && $_POST["apaterno"] && $_POST["amaterno"] && $_POST["direccion"] && $_POST["telefono"] && $_POST["email"] && $_POST["manager"] ) {
      ...
      echo "<div> Bienvenido cliente <b>". $_POST['nombre']. "</b> <b>". $_POST['apaterno']. "</b> <b>". $_POST['amaterno']. "</b> que vive en <b>".
	  $_POST['direccion'] . "</b> con teléfono <b>". $_POST['telefono']. "</b>, e-mail <b>". $_POST['email']. "</b><br></div>";
  
	}else{
	echo "<b>Por favor ingrese todos los campos</b>";
    echo "<meta http-equiv=\"refresh\" content=\"5; URL=empleados.html\" />";	
	}
...
echo "<form action=\"altaempleados.php\" method=\"post\" >\n";
...
echo "  <!--declarmos una etiqueta visible -->\n";
echo "  <label for=\"manager\">Manager:</label><br>\n";
