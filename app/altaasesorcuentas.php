...
<h2>Alta de asesor de cuentas</h2>

<p>Ingrese los datos del asesor de cuenta en los campos.</p>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<meta http-equiv=\"refresh\" content=\"5; URL=asesorcuentas.html\" />";	
	}
...
echo "<form action=\"altaasesorcuentas.php\" method=\"post\" >\n";
