...
<p>Ingrese los datos del cliente en los campos.</p>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if( $_POST["nombre"] && $_POST["apaterno"] && $_POST["amaterno"] && $_POST["direccion"] && $_POST["telefono"] && $_POST["email"] ) {
    ...
    echo "<meta http-equiv=\"refresh\" content=\"5; URL=clientes.html\" />";	
	}
...
echo "<form action=\"altaclientes.php\" method=\"post\" >";
